...
void initDisplay()
{
    ...
    ESP_LOGI(LOG_TAG, "Register io panel event callback for LVGL flush ready notification");
    ...
    ESP_LOGI(LOG_TAG, "Use esp_timer as LVGL tick timer");
    ...
    ESP_LOGI(LOG_TAG, "Create LVGL task");
